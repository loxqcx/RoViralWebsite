...
export const careersPageConfig = {
  hero: {
    ...
    title: ['Make the internet', 'care about games.'],
    body: "We're building a small network of editors, content creator managers, and clippers with sharp taste and zero fear of iteration.",
  ...
  note: {
    ...
    body: 'Join the Discord and send a tight intro with your best work. We keep a short list of people worth calling when the right project arrives.',
  },
};
