...
export const siteConfig = {
  ...
  hero: {
    ...
    stats: [
      { value: '06', label: 'Growth services' },
      { value: '3x', label: 'Average content cadence' },
  ...
  caseStudies: [
    {
      number: '01',
      client: 'Velocity Racers',
      headline: 'From quiet beta to a launch people raced to join.',
      metric: '2.8M',
      metricLabel: 'organic views in 30 days',
      summary: 'We built a repeatable creator format around close finishes, player rivalries, and challenge clips, then supported release week with a high-tempo trailer.',
      services: ['Short form', 'Trailer', 'Launch strategy'],
    },
    {
      number: '02',
      client: 'Harvest Together',
      headline: 'Turning a cozy game into a weekly social ritual.',
      metric: '186%',
      metricLabel: 'increase in Discord activity',
      summary: 'Seasonal prompts, player spotlights, and creator-managed publishing gave the community a reason to come back even when they were not in-game.',
      services: ['Community', 'Content ops', 'Short form'],
    },
    {
      number: '03',
      client: 'Night Shift',
      headline: 'A clearer promise made discovery work harder.',
      metric: '+41%',
      metricLabel: 'play-rate lift',
      summary: 'We reframed the game around its most legible fear mechanic and tested a focused system of icon and thumbnail concepts.',
      services: ['PTR boosting', 'Growth audit'],
    },
  ],
  process: [
